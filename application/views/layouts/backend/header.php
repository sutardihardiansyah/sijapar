	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
				...
				<div class="sidebar-brand-text mx-3 text-uppercase">Sijapar</div>
			</a>
			...
			<?php if ($this->session->userdata('level') == 'admin') : ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('engineer'); ?>">
						<i class="fas fa-fw fa-users"></i>
						<span>Engineer</span></a>
				</li>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('lap-booking'); ?>">
						<i class="fas fa-fw fa-chart-bar"></i>
						<span>Laporan</span></a>
				</li>
			<?php elseif ($this->session->userdata('level') == 'engineer') : ?>
				<li class="nav-item">
